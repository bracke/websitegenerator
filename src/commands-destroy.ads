...
package Commands.Destroy is
   ...
   overriding function Name (Cmd : Instance) return
      CLIC.Subcommand.Identifier is ("destroy");
   ...
   overriding function Long_Description
      ...
      ("Destroys files generated by" & " " &
       TT.Terminal ("generate") & " " & "command.")
      .New_Line
      );
   ...
   overriding function Short_Description
      (Cmd : Instance) return String is
      ("Destroys files generated by" & " " &
      TT.Terminal ("generate") & " " & "command.");
