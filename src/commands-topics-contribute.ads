...
package Commands.Topics.Contribute is
  ...
  type Topic is new CLIC.Subcommand.Help_Topic with null record;
   ...
   is (AAA.Strings.Empty_Vector.Append
     ("Please create pull request on the WebsiteGenerator project's GitHub page: ")
     .Append
     (TT.Url("https://github.com/bracke/WebsiteGenerator")).Append("Not just for code, but also for adding to the documentation or fixing spelling mistakes."));
